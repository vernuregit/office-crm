              ...
              <div className="rounded-2xl border border-gray-100 overflow-hidden">
                ...
                <div className="bg-gray-50 border-t border-gray-100 px-4 py-3 space-y-1.5">
                  ...
                  <div className="flex justify-between text-base font-black text-gray-900 pt-1.5 border-t border-gray-200">
                    <span>Total</span>
                    <span className="text-[#1D7872]">₹{(invoice.total || total).toLocaleString("en-IN")}</span>
                  </div>
                </div>
              </div>
            </div>
...
const Invoices = () => {
  ...
  return (
    <Layout title="Invoices">
      ...
      {/* Total Value Banner */}
      {invoices.length > 0 && (
        <div className="bg-[#1D7872] rounded-2xl p-5 mb-6 text-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            <IndianRupee size={22} />
            <div>

...
const Input = ({ className = "", ...props }) => (
  <input
    ...
    className={`w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-800
      placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#153485] focus:border-[#153485]
...
export default function Settings() {
  ...
  const saveBtn = (loading, label, loadingLabel, icon) => (
    <button type="submit" disabled={loading}
      className="flex items-center gap-2 bg-[#153485] disabled:opacity-50
    ...
    <Layout title="Settings">
      <div className="max-w-2xl space-y-5">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-5 flex items-center gap-4 shadow-sm">
          {/* Avatar */}
          <div className="w-12 h-12 rounded-2xl bg-[#153485] flex items-center justify-center text-white font-black text-lg flex-shrink-0 shadow-sm shadow-blue-100">
        ...
        <Section
          icon={<User size={15} />}
          title="Profile"
          iconBg="bg-[#153485]" iconBorder="border-[#153485]" iconColor="text-white"
        >

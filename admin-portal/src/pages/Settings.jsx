...
const Input = ({ className = "", ...props }) => (
  <input
    ...
    className={`w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-800
      placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#00A499] focus:border-[#00A499]
...
export default function Settings() {
  ...
  const saveBtn = (loading, label, loadingLabel, icon) => (
    <button type="submit" disabled={loading}
      className="flex items-center gap-2 bg-[#00A499] disabled:opacity-50
    ...
    <Layout title="Settings">
      <div className="max-w-2xl space-y-5">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-5 flex items-center gap-4 shadow-sm">
          {/* Avatar */}
          <div className="w-12 h-12 rounded-2xl bg-[#00A499] flex items-center justify-center text-white font-black text-lg flex-shrink-0 shadow-sm shadow-blue-100">
        ...
        <Section
          icon={<User size={15} />}
          title="Profile"
          iconBg="bg-[#00A499]" iconBorder="border-[#00A499]" iconColor="text-white"
        >

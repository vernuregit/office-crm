      ...
      <div className="bg-white border border-gray-200 rounded-2xl w-full max-w-md shadow-2xl shadow-gray-200/80 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 sticky top-0 bg-white z-10">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-[#00A499] flex items-center justify-center">
              <UserSquare2 size={16} className="text-[#00A499]" />
            </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button type="submit" disabled={loading}
              className="flex-1 bg-[#00A499] cursor-pointer disabled:opacity-50 text-white font-bold py-2.5 rounded-xl text-sm transition-all shadow-sm shadow-indigo-200">
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl p-5 hover:shadow-md hover:border-gray-200 transition-all duration-200 shadow-sm group">
      ...
      <div className="mt-4 pt-3 border-t border-gray-50 flex items-center justify-between">
        <span className="text-xs font-bold text-[#00A499] bg-indigo-50 border border-indigo-100 px-2.5 py-1 rounded-full">
          Client
        </span>
    ...
    <Layout title="Clients">
      ...
      <div className="flex items-center justify-between gap-4 mb-5">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#00A499] text-white font-bold px-4 py-2.5 rounded-xl text-sm transition-all shadow-sm shadow-indigo-200"
        >
          <Plus size={16} />
          Add Client
        </button>

                    ...
                    <div className="flex gap-2 items-center">
                      ...
                      {(inv.status === "sent" || inv.status === "overdue") && (
                        <button
                          ...
                          className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg bg-[#1D7872] text-white hover:opacity-90 transition-all font-semibold disabled:opacity-50"
                        >
                          <CreditCard size={12} />

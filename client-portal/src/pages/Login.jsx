        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl pl-11 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-#00A499 focus:border-[#00A499] transition-all bg-gray-50 focus:bg-white"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#00A499] cursor-pointer text-white font-bold py-3 rounded-xl hover:opacity-90 transition-all duration-150 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed text-sm flex items-center justify-center gap-2"
            >
              {loading

    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-[0_2px_15px_-3px_rgba(79,70,229,0.07)] p-6 mb-6">
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[#1D7872] flex items-center justify-center">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full border accent-[#1D7872] border-gray-200 rounded-xl pl-11 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#1D7872] focus:border-[#1D7872] transition-all bg-white appearance-none"
            >
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#1D7872] focus:border-[#1D7872] transition-all bg-white"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            required
            className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#1D7872]focus:border-[#1D7872] transition-all bg-white resize-none"
          />
        </div>
        ...
        <div className="flex gap-3 justify-end pt-1">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#1D7872] text-white text-sm font-bold hover:opacity-90 transition-all disabled:opacity-50 shadow-md"
          >
        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            <span className="text-xs 
             text-[#1D7872] border border-indigo-100 px-2.5 py-0.5 rounded-full font-semibold">
              {ticket.category}
            </span>
      ...
      {ticket.status !== "resolved" && (
        <div className="border-t border-gray-100 pt-4">
          ...
          <textarea
            ...
            className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#1D7872] focus:border-[#1D7872] transition-all bg-white resize-none mb-3"
          />

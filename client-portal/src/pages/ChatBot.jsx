  ...
  return (
    <Layout title="AI Assistant">
      <div className="flex flex-col h-[calc(100vh-8rem)] max-w-3xl mx-auto">
        ...
        {/* Header */}
        <div className="bg-[#00A499] rounded-2xl p-5 mb-4 text-white flex items-center gap-4 relative overflow-hidden">
        ...
        <div className="flex-1 bg-white rounded-2xl border border-gray-100 shadow-[0_2px_15px_-3px_rgba(79,70,229,0.07)] overflow-y-auto p-4 space-y-4 mb-4">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-center px-4">
              <div className="w-16 h-16 rounded-2xl bg-[#00A499] flex items-center justify-center mb-4">
        ...
        <div className="flex items-end gap-3 bg-white rounded-2xl border border-gray-200 p-3 shadow-[0_2px_15px_-3px_rgba(79,70,229,0.07)]">
          ...
          <button
            ...
            className="w-10 h-10 rounded-xl bg-[#00A499] text-white flex items-center justify-center hover:opacity-90 transition-all disabled:opacity-40 disabled:cursor-not-allowed flex-shrink-0 shadow-md"
          >
            {thinking
